...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='zest.conf'
CONFIGFOLDER='/root/.zest'
COIN_DAEMON='zestd'
COIN_CLI='zest-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ZestFoundation/ZestCoin/releases/download/v1.0.0/zest-1.0.0-x86_64-linux-gnu.tar.gz'
